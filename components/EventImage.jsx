...
const EventImage = ({ link }) => {
  return (
    <div className="group relative h-fit">
      ...
      <div className="group-hover:visible group-hover:opacity-100 opacity-0 invisible transition-all px-4 flex items-end pb-4 lg:pb-2 justify-between bottom-0 bg-gradient-to-t from-black to-[rgba(0, 0, 0, 0.4)] rounded-bl-xl rounded-br-xl absolute w-full h-1/5 ">
        <div className="flex items-center w-1/5 md:w-1/2 lg:w-1/4 justify-between">
