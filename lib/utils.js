...
const sortEventsBySearch = (events, search) => {
  ...
  return events.sort((a, b) => compareTwoStrings(b.title, search) > compareTwoStrings(a.title, search))
}
...
export { parseDate, sortEventsByDate, filterEventsBySport, sortEventsBySearch,randomId, sports };
